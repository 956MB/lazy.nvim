...
*This fork is based on the original work by [folke](https://github.com/folke/lazy.nvim) and maintains the [original license](https://github.com/folke/lazy.nvim/blob/main/LICENSE)*
